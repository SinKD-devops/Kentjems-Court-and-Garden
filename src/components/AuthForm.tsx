...
import { type AuthState, sendCode, verifyCode } from "@/app/sign-in/actions";

const initial: AuthState = {};

export function AuthForm({ phone, next }: { phone?: string; next: string }) {
  return phone ? <VerifyForm phone={phone} next={next} /> : <PhoneForm next={next} />;
}
